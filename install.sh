...
case "$DISTRO_FAMILY" in
    debian)
        ...
        echo -e "${GREEN}${BOLD}════════════════════════════════════════════════════════════════${NC}"
        echo ""
        echo -e "${BOLD}You can now use standard APT commands to manage packages:${NC}"
...
EOF
        ...
        echo -e "${GREEN}${BOLD}════════════════════════════════════════════════════════════════${NC}"
        echo ""
        echo -e "${BOLD}You can now use standard DNF commands to manage packages:${NC}"
...
EOF
        ...
        echo -e "${GREEN}${BOLD}════════════════════════════════════════════════════════════════${NC}"
        echo ""
        echo -e "${BOLD}You can now use standard Pacman commands to manage packages:${NC}"
